...
y.2010 <- predict.lm(fit.2010, data=cars2010)  
y.2011 <- predict.lm(fit.2010, data=cars2011)
y.2012 <- predict.lm(fit.2010, data=cars2012)

#couldn't get past this part
#rmse.2010 <- rmse(cars2010$FE, y.2010$FE)
#rmse.2011 <- ...
#rmse.2012 <- ... 
